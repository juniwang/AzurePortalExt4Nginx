...
module BladeDefinitions {
    ...
    export class ParametersFileEditorBladeReference<TResult, TConfig> extends FxSelectable2.ParameterProviderBladeReference<void, TResult, TConfig> {
        public constructor(options: FxSelectable2.ParameterProviderOptions<void, TResult, TConfig>) {
            super("ParametersFileEditorBlade", extensionName, options);
        }
    }
