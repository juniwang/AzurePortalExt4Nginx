...
module ExtensionDefinition {
  ...
  "htmlTemplates": {}
    ...
    export interface NginxCreate$CreateBladeViewModel$Contract extends ViewModels.NginxCreate.CreateBladeViewModel.Contract {
    }
    ...
    export interface NginxCreateDataContextContainer extends FxImpl.Extension.DataContextContainer<NginxCreate.DataContext> {
    }
    export interface NginxCreateViewModelFactories extends NginxCreateDataContextContainer {
        CreateBladeViewModel(container: FxCompositionPdlBlade.Container, initialState?: any): MsPortalFx.Base.PromiseV<NginxCreate$CreateBladeViewModel$Contract>;
    }
    export interface ViewModelFactories {
        ...
        NginxCreate(): ExtensionDefinition.NginxCreateViewModelFactories;
    }
}
